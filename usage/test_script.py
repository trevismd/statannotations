...
def make_data_types() -> dict[str, DataType]:
    ...
    pairs_missing_group = [
        (("Sat", tip_bucket_list[2]), ("Fri", tip_bucket_list[0])),
    ]
    ...
    data_types: dict[str, DataType] = {
        ...
        "df_missing_groups": {
            "params": params_df_missing_group,
            "pairs": pairs_missing_group,
            "v0_13": True,
        },
    }
    return data_types
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="append",
        type=str,
        choices=list(orient_types),
        help="Plot orientation to test.",
    )
    ...
    # Filter orientation types
    if args.orient_type:
        orient_types = [o for o in orient_types if o in args.orient_type]
